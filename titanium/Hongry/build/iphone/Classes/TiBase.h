...
// in simulator we redefine to format for Hongry Developer console
...
{\
	NSString * exceptionName = [@"org.hongry." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hongry";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIHongryNativeItemNone = -1, 
	UIHongryNativeItemSpinner = -2,
	UIHongryNativeItemProgressBar = -3,
	
	UIHongryNativeItemSlider = -4,
	UIHongryNativeItemSwitch = -5,
	UIHongryNativeItemMultiButton = -6,
	UIHongryNativeItemSegmented = -7,
	
	UIHongryNativeItemTextView = -8,
	UIHongryNativeItemTextField = -9,
	UIHongryNativeItemSearchBar = -10,
	
	UIHongryNativeItemPicker = -11,
	UIHongryNativeItemDatePicker = -12,
	
	UIHongryNativeItemInfoLight = -13,
	UIHongryNativeItemInfoDark = -14,
	
	UIHongryNativeItemDisclosure = -15,
	
	UIHongryNativeItemContactAdd = -16
};
